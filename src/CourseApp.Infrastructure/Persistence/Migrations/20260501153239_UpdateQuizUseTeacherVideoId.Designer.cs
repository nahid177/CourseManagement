...
namespace CourseApp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260501153239_UpdateQuizUseTeacherVideoId")]
    partial class UpdateQuizUseTeacherVideoId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseApp.Core.Entities.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CourseApp.Core.Entities.BookCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CourseApp.Core.Entities.BookCategoryMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("book_category_mappings", (string)null);
                });

            modelBuilder.Entity("CourseApp.Core.Entities.BookOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("book_orders", (string)null);
                });

            modelBuilder.Entity("CourseApp.Core.Entities.BookOrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("book_order_items", (string)null);
                });

            modelBuilder.Entity("CourseApp.Core.Entities.BookPayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("book_payments", (string)null);
                });
            ...
            modelBuilder.Entity("CourseApp.Core.Entities.CourseCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CourseApp.Core.Entities.BookCategoryMapping", b =>
                {
                    b.HasOne("CourseApp.Core.Entities.BookCategory", "BookCategory")
                        .WithMany("BookCategoryMappings")
                        .HasForeignKey("BookCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CourseApp.Core.Entities.Book", "Book")
                        .WithMany("BookCategoryMappings")
            ...
            modelBuilder.Entity("CourseApp.Core.Entities.BookOrderItem", b =>
                {
                    ...
                    b.HasOne("CourseApp.Core.Entities.BookOrder", "BookOrder")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("CourseApp.Core.Entities.Course", b =>
                {
                    b.HasOne("CourseApp.Core.Entities.CourseCategory", "CourseCategory")
                        .WithMany("Courses")
